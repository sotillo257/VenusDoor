...
namespace DataAccess
{
    public class Connection
    {
        ...
        //public string _CN = @"Data Source=.;Initial Catalog=VenusCabinetDoors;Integrated Security = True";  // BD LOCAL JESUS 
        public string _CN = @"Data Source=sql5028.site4now.net;Initial Catalog=DB_A448B1_venusdoorsDB;User Id=DB_A448B1_venusdoorsDB_admin;Password=venussage123;"; //BD Dev
