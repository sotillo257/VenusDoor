...
namespace DataAccess
{
    ...
    {
        //public string _CN = @"Data Source=sql5032.site4now.net;Initial Catalog=DB_A4673B_venusdoorsbmt;User Id=DB_A4673B_venusdoorsbmt_admin;Password=bmt12345!;"; // BAse de datos REMOTAAAA        
