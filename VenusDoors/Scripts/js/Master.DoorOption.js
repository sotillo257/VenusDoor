$(document).ready(function () {
    ...
    $(document).on('click', '.Modificar', function (event) {
        ...
        QuitarClaseErrorACombos();
        Limpiar();
        for (var i = 0; i < listDoorOption.length; i++) {
            if (listDoorOption[i].Id == $(this).attr('value')) {
              
                $('#inId').val(listDoorOption[i].Id);
                llenarComboEstatus(listDoorOption[i].Status.Id);
                $('#inDescription').val(listDoorOption[i].Description);
            }
        }
    });
});
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result == true) {
                ...
                llenarTablaDoorOption();
            } else {
                LlammarModal("Danger", "Error: An error occurred while inserting.", " ");
            }
        },
        error: function (err) {
            LlammarModal("Danger", "Error.", "InsertDoorOption");
        },

    });
}
function UpdateDoorOption() {
    ...
    $.ajax({
        ...
        error: function (err) {
            LlammarModal("Danger", "Error.", "UpdateDoorOption");
        },
...
function UpdateStatus3(id) {
    ...
    $.ajax({
        ...
        error: function (err) {
            LlammarModal("Danger", "Error.", "DeleteDoorOption(195)");
        },
...
function llenarTablaDoorOption() {
    $.ajax({
        ...
        success: function (data) {
            if (data != null) {
                ...
                LlammarModal("Danger", "Error obtaining all Door Option", " ");
            }
        },
        error: function (err) {
            LlammarModal("Danger", "Error.", "llenarTablaDoorOption");
        }
    });
