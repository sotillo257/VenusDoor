...
namespace VenusDoors.Controllers
{
    public class OrderSummaryController : Controller
    {
        ...
        public void SendOrderToManage(Order CompleteOrder)
        {
            ...
            string cuerpo = "<table width=700 border=0 cellspacing=0 cellpadding=0 style=background:#f7f7f7;font-family:Arial,Helvetica,sans-serif;font-size:17px><tbody><tr><td style = padding:20px><p> ------------------------&nbsp; &nbsp; &nbsp;Order Summary &nbsp; &nbsp; --------------------------<br> Order id &nbsp;#:" + CompleteOrder.Id + "<br>Estimate&nbsp;Date:&nbsp;" + date + "<br>Total:&nbsp;$" + CompleteOrder.Total + "<br>The&nbsp;complete&nbsp;version&nbsp;has&nbsp;been&nbsp;<wbr>provided&nbsp;as&nbsp;an&nbsp;attachment&nbsp;to&nbsp;<wbr>this&nbsp;email.<br>---------------------------------------------------------------------</p></td></tr></tbody></table> ";
